...
List and register use `/api/registeredmodels/v2`. Get, update, versions, and modelapis use `/api/registeredmodels/v1/{modelName}`; `modelName` is the registered model name, not a UUID.
