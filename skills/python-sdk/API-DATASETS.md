...
Dataset list v2 often caps near 100 rows and may ignore some query filters; page with offset and re-filter client-side if needed. See [API-REFERENCE.md](API-REFERENCE.md#pagination).
